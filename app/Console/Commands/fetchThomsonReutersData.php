...
class fetchThomsonReutersData extends Command
{
    ...
    public function handle()
    {
        ...
        echo "Start ..."."\n";
         $fileUrl = "https://www.world-check.com/premium-dynamic-download/?lag=WEEK&format=XML&anykeyword=1&subcategory=PEP%20NG&subcategory=PEP%20NG-A&subcategory=PEP%20NG-R&subcategory=PEP%20IO&subcategory=PEP%20IO-A&subcategory=PEP%20IO-R&subcategory=PEP%20L&subcategory=PEP%20L-A&subcategory=PEP%20L-R&subcategory=PEP%20N&subcategory=PEP%20N-A&subcategory=PEP%20N-R&subcategory=PEP%20RO&subcategory=PEP%20RO-A&subcategory=PEP%20RO-R&subcategory=PEP%20SN&subcategory=PEP%20SN-A&subcategory=PEP%20SN-R&subcategory=SIE&subcategory=SOE&subcategory=&category=BANK&category=CORPORATE&category=COUNTRY&category=CRIME%20-%20FINANCIAL&category=CRIME%20-%20NARCOTICS&category=CRIME%20-%20ORGANIZED&category=CRIME%20-%20OTHER&category=CRIME%20-%20TERROR&category=CRIME%20-%20WAR&category=DIPLOMAT&category=EMBARGO&category=EMBARGO%20VESSEL&category=INDIVIDUAL&category=LEGAL&category=MILITARY&category=NONCONVICTION%20TERROR&category=ORGANISATION&category=POLITICAL%20INDIVIDUAL&category=POLITICAL%20PARTY&category=PORT&category=RELIGION&category=TERRORISM&category=TRADE%20UNION&category=VESSEL"; 

        $saveTo = $_SERVER['DOCUMENT_ROOT'] .'public/TS/reutersData.xml';
        $fp = fopen($saveTo, 'w+');
        if($fp === false){
