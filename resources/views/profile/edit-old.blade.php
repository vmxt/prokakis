                                    ...
                                    <div id="tabs-1">
                                        ...
                                        <div class="card-body center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" cols="20" class="form-control" name="description"
...
<?php
                                ...
                                <div class="tab-pane" id="portlet_tab4">
                                                ...
                                                <ol>
                                                    ...
                                                    <li style="padding:5px;" id="awardsSaved<?php echo $aw[0]; ?>">
                                                        ...
                                                        <span style="float:right"><?php echo $aw[3]; ?> - <a
                                                                    ...
                                                                    href="#"
                                                                    onclick="processRemoveFile('<?php echo $aw[0]; ?>', 'awardsSaved', '<?php echo $aw[2]; ?>');">Delete</a></span>
                                                    </li>
                                                    <?php } ?>
                                                </ol>
                                                <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="upload1">
                                            <form method="post" action="{{ route('uploadPurchaseInvoices') }}"
                                                ...
                                                <?php if(count($profilePurchaseInvoice) > 0) { ?>
                                        ...
                                        <div id="upload2">
                                            <form method="post" action="{{ route('uploadSalesInvoies') }}"
                                                ...
                                                <?php if(count($profileSalesInvoice) > 0) { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="upload3">
                                            <form method="post" action="{{ route('uploadCertifications') }}"
                                                ...
                                                <?php if(count($profileCertifications) > 0) { ?>
                                ...
                                <div class="tab-pane" id="portlet_tab5">
                                    <div class="card-header"><b>Financial Entries</b></div>
                                    <div class="card-body center">
