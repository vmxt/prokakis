                ...
                <div class="mt-content-body">
                    <div class="col-md-8">
                        <div class="portlet light ">
                            ...
                            <form id="company_billing_form" method="POST" action="{{ route('createBilling') }}">
                                {{ csrf_field() }}
                                <div class="card">

                                    <div class="card-header"><b>BILLING ACCOUNT INFORMATION</b></div>
                                    <br>
                                    <div class="card-body center">

                                        <div class="form-group">
                                            <label for="account_name">Name</label>
                                            <input type="text" class="form-control" readonly="true" name="account_name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="account_email" readonly="true"
        ...
        $("#ajxUpdate").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(".popup").hide(250);
                    document.location = "{{ route('indexBilling') }}"
                }
            });
