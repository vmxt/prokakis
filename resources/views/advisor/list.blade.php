        ...
        <div class="portlet light">
            ...
            <div class="portlet-title">
                ...
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue sbold uppercase">Redemption Request</span>
                ...
                <table id="system_data" class="table table-hover table-light">
                    ...
                    <thead>
                     <tr>
                        ...
                        <th style="width:10%">Points / Earned Amount</th>

                        <th style="width:20%">Status</th>
                        
                        <th style="width:40%">Points and Scores</th>
                    ...
                    <tr>
                        ...
                        <td id="tdJson<?php echo $data->id; ?>"><b><?php  if($data->status == 1){ echo "Pending"; } else { echo "Approved"; } ?></b></td>
                        
                      
                        <td>

                            <a id="edit_icon"  onclick="ajxProcessView('<?php echo $usr->id; ?>','<?php echo $usr->firstname.' '.$usr->lastname; ?>')"
                            ...
                            <a id="edit_icon"  onclick="ajxViewRedemptionDetails('<?php echo $data->id; ?>')" data-popup-open="popup-2" class="btn btn-outline btn-circle btn-sm blue">
                                <i class="fa fa-edit"></i>Check Advisor
                            </a>

                            <a id="edit_icon"  onclick="ajxViewEnterpriseDetails('<?php echo $data->id; ?>')" data-popup-open="popup-2" class="btn btn-outline btn-circle btn-sm blue">
                                <i class="fa fa-edit"></i>Check Enterprise
                            </a>
                      
                        </td>

                        <td>
                            <form id="approveForm" style="padding-top: 10px;" action="{{ route('redeemGetApproved') }}" method="post">
                                {{ csrf_field() }}  
                            <input type="hidden" name="reqId" value="<?php echo $data->id; ?>">    
                            <button type="button" id="submit_button" class="btn btn-outline btn-circle btn-sm red"><i class="fa fa-edit"></i> Approve</button>
                            </form>
                        </td>
...
function ajxViewEnterpriseDetails(rId)
{
    ...
    $.ajax({
        ...
        url: "{{ route('redeemEnterpriseRewards') }}",
