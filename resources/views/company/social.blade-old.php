                        ...
                        <div class="portlet-body">
                            <ul>
                               <!-- <li><i class="fa fa-flag"></i><b>Founded: </b><span style="float: right">2012</span> </li>
                                ...
                                <li><i class="fa fa-globe"></i><b>Website: </b> <span style="float: right"><?php echo $companyProfile->company_website; ?></span> </li>
                               <li><i class="fa fa-envelope"></i><b>Email: </b> <span style="float: right"><?php echo $companyProfile->company_email; ?></span></li> 
                            </ul>
                            <div class="hr-sect" style="margin-top: 25px; margin-bottom: 25px;">Social Media Accounts</div>
                            <ul>
                                <li> <i class="fa fa-facebook"></i>facebook.com/<?php echo $companyProfile->facebook; ?></li>
                                <li> <i class="fa fa-twitter"></i>twitter.com/<?php echo $companyProfile->twitter; ?></li>
                                <li> <i class="fa fa-linkedin"></i>instagram.com/<?php echo $companyProfile->linkedin; ?></li>
                                <li> <i class="fa fa-instagram"></i>instagram.com/<?php echo $companyProfile->otherlink; ?></li>  
                            </ul>
                        </div>
                    </div>
                    <!-- END Portlet PORTLET-->
