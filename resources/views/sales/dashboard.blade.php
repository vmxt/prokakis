                   ...
                   <div class="portlet light ">
                       <div class="well well-lg justify-content-center">
                           <div class="note note-success">
                            Prokakis sales account allows you to manage the redemption request from rewards and gamification. <br />
                           </div>

                           <div class="row">

                           To open redemtion quest list click <a href="{{ url('advisor') }}"><b>here</b></a> <br />
