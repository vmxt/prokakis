...
<![endif]-->
      ...
      <!-- BEGIN CORE PLUGINS -->
            ...
            <!-- END CORE PLUGINS -->
            <!-- BEGIN PAGE LEVEL PLUGINS -->
            <script src="public/assets/global/plugins/ladda/spin.min.js" type="text/javascript"></script>
            <script src="public/assets/global/plugins/ladda/ladda.min.js" type="text/javascript"></script>
            <!--
            ...
            <script src="public/assets/pages/scripts/ui-buttons-spinners.min.js" type="text/javascript"></script>
            ...
            <script>
                $(document).ready(function()
                {
                            ...
                            $("#keywordsearch").hide();
                            $("#brandreputation").hide();
                            $("#personalreputation").hide();
                            $("#localbusinessreputation").hide();
                            $("#twitteraccountmetrics").hide();
                            $("#facebookpagemonitoring").hide();
                            $("#searchFilters").hide();
                            $("#searchFilters_limitlang").hide();
                      

                    $("#radioKS, #radioBR, #radioPR, #radioLBR, #radioTAM, #radioFPM").click(function () {

                        if ($("#radioKS").is(":checked")) {
                            $("#keywordsearch").show();
                            $("#brandreputation").hide();
                            $("#personalreputation").hide();
                            $("#localbusinessreputation").hide();
                        ...
                        else if ($("#radioBR").is(":checked")) {
                            $("#keywordsearch").hide();
                            $("#brandreputation").show();
                            $("#personalreputation").hide();
                            $("#localbusinessreputation").hide();
                            $("#twitteraccountmetrics").hide();
                            $("#facebookpagemonitoring").hide();
                        ...
                        else if ($("#radioPR").is(":checked")) {
                            $("#keywordsearch").hide();
                            $("#brandreputation").hide();
                            $("#personalreputation").show();
                            $("#localbusinessreputation").hide();
                            $("#twitteraccountmetrics").hide();
                            $("#facebookpagemonitoring").hide();
                        ...
                        else if ($("#radioLBR").is(":checked")) {
                            $("#keywordsearch").hide();
                            $("#brandreputation").hide();
                            $("#personalreputation").hide();
                            $("#localbusinessreputation").show();
                            $("#twitteraccountmetrics").hide();
                            $("#facebookpagemonitoring").hide();
                        ...
                        else if ($("#radioTAM").is(":checked")) {
                            $("#keywordsearch").hide();
                            $("#brandreputation").hide();
                            $("#personalreputation").hide();
                            $("#localbusinessreputation").hide();
                            $("#twitteraccountmetrics").show();
                            $("#facebookpagemonitoring").hide();
                            $("#searchFilters").hide();
                            $("#searchFilters_limitlang").hide();
                        ...
                        else if ($("#radioFPM").is(":checked")) {
                            $("#keywordsearch").hide();
                            $("#brandreputation").hide();
                            $("#personalreputation").hide();
                            $("#localbusinessreputation").hide();
                            $("#twitteraccountmetrics").hide();
                            $("#facebookpagemonitoring").show();
                            $("#searchFilters").hide();
                            $("#searchFilters_limitlang").show();

                        } 

                        $('ul li a[href="#tab12"]').click();

                        });

                        $('#btnBackSearchType').click(function() {
                            $('ul li a[href="#tab11"]').click();
                        });

                        $('#btnNextFilter').click(function() {
                            $('ul li a[href="#tab13"]').click();
                        });
