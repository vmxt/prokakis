...
<head>
    ...
    <!--<link href="{{ asset('css/app.css') }}" rel="stylesheet">-->
        ...
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
        <!-- END GLOBAL MANDATORY STYLES -->

        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/morris/morris.css" rel="stylesheet'" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/global/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL STYLES -->
        <link href="https://reputation.prokakis.com/public/assets/global/css/components.min.css" rel="stylesheet" id="style_components" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/global/css/plugins.min.css" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="https://reputation.prokakis.com/public/assets/layouts/layout2/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="https://reputation.prokakis.com/public/assets/layouts/layout2/css/themes/blue.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <link href="https://reputation.prokakis.com/public/assets/layouts/layout2/css/custom.min.css" rel="stylesheet" type="text/css" />
        <!-- END THEME LAYOUT STYLES -->
        <link rel="shortcut icon" href="https://reputation.prokakis.com/favicon.ico" /> 
                        ...
                        <div class="col-lg-6 col-xs-12 col-sm-12">
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject bold uppercase font-dark">Reset Password</span>
                                    </div>
   ...
   <!-- BEGIN FOOTER -->
    <div class="page-footer">
            ...
            <div class="page-footer-inner"> 2019 &copy; Ebosreputation
                ...
                <a href="http://Intellinz.com" title="Intellinz" target="_blank">Intellinz</a>
