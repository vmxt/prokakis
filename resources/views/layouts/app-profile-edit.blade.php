                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown {{ (request()->segment(2) == '') ? 'active' : '' }}">
                                            ...
                                            @guest
                                                ...
                                                <a class="navbar-brand" href="{{ url('/') }}">
                                                    ...
                                                    <i class="fa fa-home"></i>    {{ config('app.name', 'Prokakis') }}
                                        ...
                                        (request()->segment(1) == 'businessnews') ? 'active' : '' || (request()->segment(1) == 'alertedRecords') ? 'active' : '' }} ">
                                                ...
                                                <ul class="dropdown-menu pull-left">
                                                        ...
                                                        <li aria-haspopup="true" class=" ">
                                                               ...
                                                               <i class="icon-bulb" style="color: white"></i> Opportunities and News</a>
...
{
  $.getJSON('http://localhost/prokakis/getCompanyNames', function(dataA) {
