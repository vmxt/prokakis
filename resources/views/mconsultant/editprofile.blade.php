        ...
        <div class="row justify-content-center">
                                        ...
                                        <div class="card-header">
                                                ...
                                                <div class="containerCimg">
                                                    ...
                                                    <div class="actionCimg">
                                                            ...
                                                            <input class="m-2 btn btn-primary" type="button" id="btnCrop" value=" Crop " style="float: right;margin:3px ">

                                                            <input class="m-2 btn btn-primary" type="button" id="btnZoomIn" value="+" style="float: right;margin:3px">

                                                            <input class="m-2 btn btn-primary" type="button" id="btnZoomOut" value="-" style="float: right;margin:3px">
            ...
            <div class="col col-md-8">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-title tabbable-line">
                        ...
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark bold uppercase">Edit Master Consultant Profile</span>
                ...
                <!-- START FORM TAG-->
                    ...
                    <form action="{{ route('storeProfileMC') }}" enctype="multipart/form-data" id="company_profile_form" method="POST">
                                        ...
                                        <div class="card-body center">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div id="upload3">
                                                        ...
                                                        <form method="post" action="{{ route('uploadCertificationsMC') }}" enctype="multipart/form-data">
