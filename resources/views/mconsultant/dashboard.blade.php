   ...
   <div class="row justify-content-center">
       ...
       <div class="col-md-8">
                   ...
                   <div class="portlet light ">
                       <div class="card">
                           <div class="note note-success">
                               <h4 class="block">ENHANCE YOUR MASTER CONSULTANT PROFILE COMPLETION SCORE</h4>
                           </div>
                           <div class="row">
                               ...
                               <div class="col col-lg-8" style="margin-top: 5px;">
                                   ...
                                   <a href="{{ route('editProfileMC') }}" class="btn btn-primary" style="margin-top: 15px;">Enhance
                                       Profile</a>
                               </div>
                           </div>
                       </div>
           ...
           <div class="row widget-row">
               <div class="col-md-6">
                   ...
                   <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                       <h4 class="widget-thumb-heading">pending order by consultant</h4>
                       <div class="widget-thumb-wrap">
                           <i class="widget-thumb-icon bg-blue fa fa-clock-o"></i>
                           <div class="widget-thumb-body">
                               <span class="widget-thumb-subtitle hidden"></span>
                               <span class="widget-thumb-body-stat" style="margin-top: 25px;">
                                            <span class="counter"
                                                  data-count=" <?php if (!empty($countPending)) {
                                                      echo $countPending;
                                                  } ?>"></span>
               ...
               <div class="col-md-6">
                   <!-- BEGIN WIDGET THUMB -->
                   <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                       <h4 class="widget-thumb-heading">waiting for approval</h4>
                       <div class="widget-thumb-wrap">
           ...
           <div class="row widget-row">
             ...
             <div class="col-md-4">
                        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20">
                            <h4 class="widget-thumb-heading"> On going jobs</h4>
                            <div class="widget-thumb-wrap">
                                <i class="widget-thumb-icon bg-blue fa fa-archive" aria-hidden="true"></i>
                                <div class="widget-thumb-body">

                                    <span class="widget-thumb-body-stat">
                                                 <span class="counter" data-count=" <?php if (!empty($countOngoing)) {
                                                     echo $countOngoing;
                                                 } ?>"></span>
               ...
               <div class="col-md-4">
                   <!-- BEGIN WIDGET THUMB -->
                   <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                       <h4 class="widget-thumb-heading">completed job</h4>
                       <div class="widget-thumb-wrap">
                           <i class="widget-thumb-icon bg-blue fa fa-check-square-o"></i>
                           <div class="widget-thumb-body">

                               <span class="widget-thumb-body-stat">
                                            <span class="counter" data-count=" <?php if (!empty($countDone)) {
                                                echo $countDone;
                                            } ?>"></span>
