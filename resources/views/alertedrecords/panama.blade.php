...
<div class="container">
    <ul class="page-breadcrumb breadcrumb" style="margin-top: 10px;">
        ...
        <li>
            <span>Investor Alert List, Panama </span>
        </li>
    </ul>
    <div class="row justify-content-center">
             ...
             <div class="col-md-12">
              ...
              <table id="panama_data" class="display hover row-border stripe compact">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                            <?php
                            if(count((array)$panamaData) > 0)
                            {
                                foreach($panamaData as $d){
                            ?>
                              <tr>
