...
<div class="container">
    <ul class="page-breadcrumb breadcrumb" style="margin-top: 10px;">
        ...
        <li>
            <span>Investor Alert List, Paradise </span>
        </li>
    </ul>
    <div class="row justify-content-center">
             ...
             <div class="col-md-12">
              ...
              <div id="container">
              <table id="system_data_paradise" class="display hover row-border stripe compact">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                            ...
                            <?php
                            if(count((array)$paradiseData) > 0)
                            {
                              //$data = array_reverse($data_ia, true);

                                    foreach($paradiseData as $d){
                            ?>
                              <tr>
...
$(document).ready( function () {
   ...
   $('#system_data_paradise').DataTable({
    "aSorting": [[ 5, "desc" ]],
    "bJQueryUI": true,
...
$("#iconx"+idx).prop('class', 'icon-arrow-down');
              ...
              formData.append("model", 'Paradise Alert List');
