...
<div class="container">
    <ul class="page-breadcrumb breadcrumb" style="margin-top: 10px;">
        ...
        <li>
            <span>Investor Alert List, Bahamas </span>
        </li>
    </ul>
    <div class="row justify-content-center">
             ...
             <div class="col-md-12">
              ...
              <div id="container">
              <table id="system_data_bahamas" class="display hover row-border stripe compact">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                            ...
                            <?php
                            if(count((array)$bahamasData) > 0)
                            {
                          
                                foreach($bahamasData as $d){
                            ?>
                              <tr>
