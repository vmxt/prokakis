<div class="card">
    ...
    <div class="card-body p-0">
        ...
        <table class="table table-sm table-bordered" >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $response_twitter->neg }}</td>
  
              <td>{{ $response_twitter->neu }}</td>
  
              <td>{{ $response_twitter->pos }}</td>
            </tr>
            ...
            <tr>
                ...
                <td>{{ $response_theweb->neg }}</td>
  
                <td>{{ $response_theweb->neu }}</td>
    
                <td>{{ $response_theweb->pos }}</td>
              ...
              <tr>
                ...
                <td>{{ $response_youtube->neg }}</td>
  
                <td>{{ $response_youtube->neu }}</td>
    
                <td>{{ $response_youtube->pos }}</td>
      ...
      <div id="social_card">
        <h3> Twitter </h3> <br />
        @if(!empty($response_twitter->rs_twit))
         <?php $x = 0; ?>
      ...
      <div id="social_card">
        ...
        @if(!empty($response_youtube->rs_youtube))
         <?php $x = 0; ?>
         
         @foreach( $response_youtube->rs_youtube as $social_val )
            <?php $x++; ?>
              <div class=" card">
      ...
      <div id="social_card">
        ...
        @if(!empty($response_theweb->rs_google))
         <?php $x = 0; ?>
         
         @foreach( $response_theweb->rs_google as $social_val )
            <?php $x++; ?>
              <div class=" card">
