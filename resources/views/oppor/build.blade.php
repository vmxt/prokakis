                            ...
                            <div class="portlet light">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" cols="20"  maxlength="500" class="form-control" name="intro_describe_business"
                            ...
                            <div class="portlet light">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" cols="20"  maxlength="500" class="form-control" name="why_partner_goal"
                        ...
                        <div class="card-body center">
                            ...
                            <?php 
                                        ...
                                        if( App\SpentTokens::validateLeftBehindToken($company_id_result) != false ){
                                           ...
                                           <button type="button" id="butPrivate" <?php echo $bKP; ?> class="btn btn-success" onclick="privacyOption2('build', 'keep_private', '<?php echo $dataID; ?>')" style="color: black;"><span class="fa fa-lock"></span> Publish Anonymously </button>  
