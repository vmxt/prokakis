    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12" style="min-height:800px">
                ...
                <form id="opportunity_buy_form" method="POST" action="{{ route('opportunityStoreBuy') }}">
                            ...
                            <div class="portlet light" id="sect_inventory_opportunity">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required="required"  type="text" class="form-control input-text-form numberinput" id="inventory_value" name="inventory_value" dataName='inventory_value' value="<?= isset($data->inventory_value) ? number_format((int)$data->inventory_value) : '' ?>" >
...
//start autostore
        ...
        $("#currency").change(function() { 
            if(! $('#oppor_id').val() ){
            cookies.set('buy_currency',  $("#currency").val() );
            }
        }); 
...
if(! $('#oppor_id').val() ){
   ...
   if( cookies.get("buy_currency") ){
     $('#currency').val(  cookies.get("buy_currency") );
