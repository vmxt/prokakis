    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12" style="min-height:800px">
            ...
            <div class="card">
                   ...
                   <b>This request report requires a 12 token, please enter your details so that we can contact you once the report is ready.</b>
                   <br />
                    ...
                    <div class="card-body center">
                       ...
                       {!! Form::model($requestReport, ['action' => 'OpportunityController@storeSearchCompany']) !!} 
