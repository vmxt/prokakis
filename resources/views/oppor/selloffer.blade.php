...
@section('content')
                            ...
                            <div class="portlet light" style="margin-top: 10px;">
                                <div class="portlet-body">
                                    <div class="form-group">
                                        ...
                                        <label for="ideal_partner_base"><b>(Indicate the location of your ideal partners)  <!--Type and click to add Countries --> </b></label>
    ...
    <script src="{{ asset('public/assets/global/plugins/bootstrap-multiselect/js/bootstrap-multiselect.js') }}" type="text/javascript"></script>
