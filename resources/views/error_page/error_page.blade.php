        ...
        <div class="bootstrap row justify-content-center">
            ...
            <div class="card">
                <div style="text-align:center" class="card-body ">
                    <h1 class="card-title text-danger"><i class="fa fa-exclamation-triangle"></i>&nbsp;YOU HAVE ENCOUNTERED AN ERROR, WE ARE WORKING TO FIX THIS AS SOON AS POSSIBLE! THANK YOU.</h1>
                    <a style="min-width:100px" href="javascript:history.back()" class="btn btn-primary btn-lg">BACK</a>
                </div>
            </div>
