                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <h3 style="margin:0px !important"><i class="fa fa-file"></i> <b>PROFIT AND LOSS</b></h3>
                            </div>
                            <div class="col-md-6 mb-2">
                                <button type="button" class="btn btn-primary pull-right" id="profit_loss_save_btn" ><i class="fa fa-save"></i> SAVE IN INTELLINZ</button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label>Title:</label>
                                <input value="{{ $title }}" type="text" placeholder="........" id="profit_loss_title_txt"  class="form-control" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label>Description:</label>
                                <input value="{{ $description }}" type="text" placeholder="........" id="profit_loss_description_txt"  class="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $("#profit_loss_save_btn").click(function(){
            ...
            if(title == "" || description == ""){
                alert("Please provide title and description for this Profit and Loss");
            }
            else{
