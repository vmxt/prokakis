            ...
            <div class="col-md-12">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-bulb "></i>
                                <span class="caption-subject  sbold uppercase">Bank Account: {{ $bank_name }}</span>
                            </div>
                        ...
                        <div  class="card mb-2" >
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            <h2>Transaction: <b>{{ $t_type }} MONEY</b></h2>
                                        </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div id="container" class="card mb-2" >
                                ...
                                <table id="system_data" class="ui celled table stripe" style="width:100%;display:none">
                                    <thead>
                                    <tr>
                                        <th>ITEM CODE</th>
                                        <th>DESCRIPTION</th>
                                        ...
                                        <th >ACCOUNT</th>
                                        <th class="text-align-right">TAX RATE</th>
                                        <th class="text-align-right">AMOUNT {{ $currency }}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
