    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
                                        ...
                                        <div class="card-header">
                                                ...
                                                <div class="containerCimg">
                                                    ...
                                                    <div class="actionCimg">
                                                            ...
                                                            <input class="btn btn-primary" type="button" id="btnCrop" value=" Crop " style="float: right ;margin:3px ">
                                                            <input class="btn btn-primary" type="button" id="btnZoomIn" value="+" style="float: right;margin:3px ">
                                                            <input class="btn btn-primary" type="button" id="btnZoomOut" value="-" style="float: right;margin:3px ">
            ...
            <div class="col col-md-8">
                <div class="portlet light ">
                    <div class="portlet-title tabbable-line">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark bold uppercase">Edit Consultant Profile</span>
                        </div>
                ...
                @endif
                <!-- START FORM TAG-->
                    <form action="{{ route('storeProfileSC') }}" enctype="multipart/form-data" id="company_profile_form" method="POST">
                        {{ csrf_field() }}
                                    ...
                                    <div id="tabs-1">
                                        ...
                                        <div class="card-body center">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    ?>
                                                    <input type="radio" <?php echo $phone_type_selected_office ?> name="phone_type" value="office_line"> Office Line <br>
                                                    <input type="radio" <?php echo $phone_type_selected_mobile ?> name="phone_type" value="mobile_line"> Mobile Line <br>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div id="upload3">
                                                        <form method="post" action="{{ route('uploadCertificationsSC') }}" enctype="multipart/form-data">
                                                         {{ csrf_field() }}
                                                            <div id="drop3">
                                                            ...
                                                            <?php if(count((array)$profileCertifications) - 1 > 0) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <button id="saveButtonCompanyProfile" type="button" class="btn btn-primary" ><i class="fa fa-save"></i> SAVE</button>
                        </div>
