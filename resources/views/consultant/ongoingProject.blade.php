                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption">
                                ...
                                <span class="caption-subject  sbold uppercase">List of On-going Projects</span>
                                        ...
                                        <form action="{{ route('updateOngoingProjectSC') }}" method="POST" enctype="multipart/form-data" id="form_<?php echo $d->id; ?>">
                                           ...
                                           <input type="hidden" name="project_id" value="<?php echo $d->id; ?>">
                                            ...
                                            <td align="center">
                                                ...
                                                $usr = App\CompanyProfile::find($d->company_requester_id);
                                            ...
                                            <td align="center">
                                                    ...
                                                    $usr = App\CompanyProfile::find($d->company_source_id);
                                                    ...
                                                    { ?>
                                                     ...
                                                     <a href="{{ url('/profile/viewer/'. $usr->id) }}" target="_blank" onclick="return confirm('Are you sure to open the company profile in another page?')"><?php echo $usr->company_name; ?></a>
                                            ...
                                            <td align="center">
                                             ...
                                             <input type="text" class="form-control" style="width:100px;" name="project_progress<?php echo $d->id; ?>" value="<?php echo (isset($d->progress))?  $d->progress : 0; ?>">
