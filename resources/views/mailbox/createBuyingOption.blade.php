            ...
            <div class="col-md-9">
                <div class="portlet light">
                    <div class="card">
                        ...
                        <form id="company_social_form" method="POST" action="{{ route('StoreEnterpriseCompose') }}">
                            {{ csrf_field() }}
                            @if (session('status'))
                            ...
                            <div id="container">
                                <form action="#">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <input type="text" class="form-control" disabled placeholder="" value="[prokakis administrators]" name="receiver_mail" id="receiver" style="padding: 0px;">
                                    </div>
                                    <div class="form-group form-md-line-input">
                                        <input type="text" class="form-control" placeholder="" value="ENTERPRISE application, for business intelligence report" name="subject_mail" id="subject_mail" style="padding: 0px;">
                                        <label for="subject_mail">Subject:</label>
                                    </div>

                                    <div class="form-group">
                                        <label for="email">Content:</label>
                                        <textarea name="composeArea" id="composeArea">{{ $msg }}</textarea>
                                    </div>
