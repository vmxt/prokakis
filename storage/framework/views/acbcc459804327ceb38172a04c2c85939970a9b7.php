<?php $__env->startSection('content'); ?>
    ...
    <link href="<?php echo e(asset('public/img-cropper/css/style.css')); ?>" rel="stylesheet">

    <link rel="stylesheet" href="<?php echo e(asset('public/css/profileedit.css')); ?>">
        ...
        <div class="row" >
            ...
            <div class="col-md-12 mb-2">
                ...
                <!-- START FORM TAG-->
                    ...
                    <form action="<?php echo e(route('storeProfile')); ?>" enctype="multipart/form-data" id="company_profile_form"
                                ...
                                <div class="tab-pane" id="portlet_tab4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="upload">
                                            ...
                                            <form method="post" action="<?php echo e(route('uploadAwards')); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="upload1">
                                            ...
                                            <form method="post" action="<?php echo e(route('uploadPurchaseInvoices')); ?>"  enctype="multipart/form-data">
                                        ...
                                        <div id="upload2">
                                            ...
                                            <form method="post" action="<?php echo e(route('uploadSalesInvoies')); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="upload3">
                                            ...
                                            <form method="post" action="<?php echo e(route('uploadCertifications')); ?>"
...
<div class="modal fade" id="update_xxxx" tabindex="-1" role="dialog" aria-labelledby="update_xxxx_label" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <!-- JavaScript Includes -->
     ...
     <script src="<?php echo e(asset('public/mini-upload/assets/js/jquery.knob.js')); ?>"></script>



    <!-- jQuery File Upload Dependencies -->

     <script src="<?php echo e(asset('public/mini-upload/assets/js/jquery.ui.widget.js')); ?>"></script>

    <script src="<?php echo e(asset('public/mini-upload/assets/js/jquery.iframe-transport.js')); ?>"></script>



    <script src="<?php echo e(asset('public/mini-upload/assets/js/jquery.fileupload.js')); ?>"></script>



    <!-- Our own JS file -->

    <script src="<?php echo e(asset('public/mini-upload/assets/js/script.js')); ?>"></script>

    <script src="<?php echo e(asset('public/mini-upload/assets/js/script1.js')); ?>"></script>

    <script src="<?php echo e(asset('public/mini-upload/assets/js/script2.js')); ?>"></script>

    <script src="<?php echo e(asset('public/mini-upload/assets/js/script3.js')); ?>"></script>
    ...
    function getFile() {
        ...
        function notifytoPremium(){
            ...
            buttons: [
              ...
              if (isConfirm) {
                    document.location = "<?php echo e(route('reportsBuyCredits')); ?>"
                } else {
        ...
        window.onload = function () {
            ...
            var options =

                {
                    ...
                    imgSrc: "<?php echo e(asset('public/images/')); ?>/<?php echo $profileAvatar; ?>"

                    <?php } else { ?>

                    imgSrc: "<?php echo e(asset('public/images/robot.jpg')); ?>"
        ...
        function uploadFile(cropf) {
            ...
            if (file != undefined) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('uploadProfileImg')); ?>",
                ...
                if (isConfirm) {
                    ...
                    swal({
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo e(route('delUploadedFile')); ?>",
        ...
        $("#ajxUpdateKM").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.location = "<?php echo e(route('editProfile')); ?>";
         ...
         var dateValue =  $("#expiryDate"+strExpiry).val();
          ...
          formData.append("date_value", dateValue);
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('updateFileExpiry')); ?>",
