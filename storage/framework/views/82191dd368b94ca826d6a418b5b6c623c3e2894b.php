<style>
    ...
    .page-wrapper {
      background-image: url("<?php echo e(asset('public/banner/login-footer.png')); ?>");
    ...
    .login2{
        background-image: url("<?php echo e(asset('public/banner/mobile-login-hero.png')); ?>");
...
@media (min-width: 768px){
    .login2{
        background-image: url("<?php echo e(asset('public/banner/login-hero.png')); ?>");
...
<!-- BEGIN LOGIN -->
    ...
    <form class="login-form" action="<?php echo e(route('login')); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?> form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>" required autofocus/>
        ...
        <div class="form-group">
            ...
            <input class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?> form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" />
        ...
        <div class="form-actions">
            ...
            <label class="rememberme check mt-checkbox mt-checkbox-outline">
                ...
                <input type="checkbox" name="remember" value="1" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?> />
            ...
            <div class="form-group">
                    ...
                    <a href="<?php echo e(url('password/reset')); ?>" id="forget-password" class="forget-password"> Forgot Password?</a> 
    ...
    <form class="forget-form" action="index.html" method="post"> <br />
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-success uppercase pull-right  <?php echo e(__('Sign In')); ?>">Submit</button>
