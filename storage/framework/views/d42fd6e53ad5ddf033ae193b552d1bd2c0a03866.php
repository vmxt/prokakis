                    ...
                    <div class="page-header">
                        ...
                        <div class="page-header-top">
                            <div class="container">
                                <!-- BEGIN LOGO -->
                                <div class="page-logo">
                                    <a href="<?php echo e(route('login')); ?>" style="margin-top: 25px;">
                                        <img src="<?php echo e(asset('public/img-resources/ProKakisNewLogo.png')); ?>" alt="Prokakis" id="logo" width="200px">
                                    </a>
                                </div>
                                <!-- END LOGO -->
                                ...
                                <div class="top-menu">
                                        ...
                                        <?php
                                           if(App\User::securePage($user_id) == 2 || App\User::securePage($user_id) == 3){
                                            ...
                                            ?>
                                                <form action="<?php echo e(route('switchAccount')); ?>" method="POST" class="btn">
                                        ...
                                        <li class="dropdown dropdown-extended dropdown-inbox dropdown-dark" id="header_inbox_bar">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="external">
                                                    ...
                                                    <a href="<?php echo e(route('mailCompose')); ?>">view all</a>
                                                </li>
                                                ...
                                                <li>
                                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                                        ...
                                                        ?>
                                                        <li>
                                                            <a href="<?php echo e(url('/mailbox/setReply/'.$n->id)); ?>">
                                                                <span class="photo">

                                                                    <img src="<?php echo e(asset('public/images/')); ?>/<?php echo $noti_profilePic; ?>" class="img-circle" alt=""> </span>
                                        ...
                                        <li id='nav-login-dropdown' class="dropdown dropdown-user dropdown-dark">
                                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                                ...
                                                if($userType == 1){
                                                    ...
                                                    if($profilePic != null){
                                                    ?>
                                                    <img class="img-circle" alt="" src="<?php echo e(asset('public/images/')); ?>/<?php echo $profilePic; ?>">
                                                    <?php } else { ?>
                                                    <img  class="img-circle" alt="" src="<?php echo e(asset('public/images/robot.jpg')); ?>">
                                                    <?php }
                                                } elseif($userType == 2){
                                                    $profilePicSC = App\CompanyProfile::getProfileImageSC(Auth::id());
                                                    if($profilePicSC != null){
                                                    ?>
                                                    <img  class="img-circle alt=" src="<?php echo e(asset('public/images/')); ?>/<?php echo $profilePicSC; ?>">
                                                    <?php } else { ?>
                                                    <img  class="img-circle alt=" src="<?php echo e(asset('public/images/robot.jpg')); ?>">
                                                    <?php }
                                                } elseif($userType == 3){
                                                    ...
                                                    ?>
                                                    <img  class="img-circle" alt="" src="<?php echo e(asset('public/images/')); ?>/<?php echo $profilePicMC; ?>">
                                                    <?php } else { ?>
                                                    <img  class="img-circle" alt="" src="<?php echo e(asset('public/images/robot.jpg')); ?>">
                                                    <?php }
                                                }
					    ...
					    if($u->m_id == null || $u->m_id == 0){ 	
                                            ?>
                                                    ...
                                                    <a href="<?php echo e(route('getTokenActivated')); ?>">
                                                        <i class="icon-wrench"></i> Manage Account </a>
                                                </li>	

                                                <li aria-haspopup="true" id="nav-buy-credit">
                                                    <a href="<?php echo e(url('/reports/buyCredits')); ?>" class="nav-link  "><i class="fa fa-dollar"></i> Buy Credits</a>
                                                </li>

                                                <li id='nav-login-company'>

                                                    <a href="<?php echo e(route('viewingProfile')); ?>">
                                                        <i class="icon-user"></i> My Company </a>
                                                </li>


                                                <li id="nav-login-inbox">
                                                    <a href="<?php echo e(route('mailCompose')); ?>">
                                                ...
                                                <li id='nav-login-switch-company'>
                                                    ...
                                                    <a href="<?php echo e(route('viewingProfile')); ?>"  data-popup-open="popup-company" >
                                                        <i class="icon-list"></i> Switch a Company </a>
                                                </li>

                                                <li id='nav-login-referral'>

                                                    <a href="<?php echo e(route('referralsList')); ?>" >
                                                        <i class="icon-rocket"></i> Referrals </a>
                                                </li>

                                                <li id='nav-login-share-friend'>

                                                    <a href="<?php echo e(route('createReferals')); ?>" >
                                                        <i class="icon-heart"></i> Share to Friend </a>
                                                </li>

                                                <li id='nav-login-rewards'>

                                                  <a href="<?php echo e(route('CompanyCreditPoints')); ?>" >
                                                      <i class="fa fa-trophy"></i> Rewards </a>
                                              </li>

 						<li>

                                                  <a href="<?php echo e(route('setPasswordData')); ?>" >
                                                ...
                                                <li id='nav-login-tour'>
                                                  ...
                                                  ?>
                                                  <?php if( isset($tour->scope) AND strpos($tour->scope , $scope) !== false ): ?>
						...
						<li>
                                                  <a href="<?php echo e(route('setSubaccounts')); ?>" >
                        ...
                        <div class="page-header-menu">
                            <div class="container">
                                ...
                                <form id="search_box" class="search-form" action="<?php echo e(route('searchByCompany')); ?>" method="GET">
                                <?php echo e(csrf_field()); ?>
                         ...
                         <!-- END HEADER SEARCH BOX -->
                                ...
                                <div class="hor-menu  ">
                                    <ul class="nav navbar-nav">
                                        <li aria-haspopup="true" id="nav-home-page" class="menu-dropdown classic-menu-dropdown <?php echo e((request()->segment(1) == 'home') ? 'active' : ''); ?>">
                                      ...
                                      <?php if($userType == 1){  ?>
                                        ...
                                        <li aria-haspopup="true" id='nav-system-dashboard' class=" menu-dropdown mega-menu-dropdown <?php echo e((request()->segment(1) == 'dashboard') ? 'active' : '' ||
                                                          ...
                                                          <li aria-haspopup="true" class=" ">
                                                            ...
                                                            <div class="col-md-9 div_right"  >
                                                              ...
                                                              <div class="mega-menu-submenu col-md-12 container_lg_img">
                                                                <a href="<?php echo e(route('opportunityExploreIndex')); ?>">
                                                                  <img class="mega_large_image" src="<?php echo e(asset('public/banner/explore_oppo.png')); ?>" alt="Top Up" />
                                                              ...
                                                              <div class="mega-menu-submenu col-md-4 container_sm_img">
                                                                <a href="<?php echo e(route('reportsBuyTokens')); ?>">
                                                                  <img class="mega_small_image" src="<?php echo e(asset('public/banner/top_up.png')); ?>" alt="Top Up" />
                                                                  <div class="text-centered" >
                                                              ...
                                                              <div class="mega-menu-submenu col-md-4 container_sm_img">
                                                                <a href="<?php echo e(route('viewingProfile')); ?>">
                                                                  <img class="mega_small_image" src="<?php echo e(asset('public/banner/view_profile.png')); ?>" alt="Top Up" />
                                                                  <div class="text-centered" >
                                                              ...
                                                              <div class="mega-menu-submenu col-md-4 container_sm_img">
                                                                <a href="<?php echo e(route('businessnewsList')); ?>">
                                                                  <img class="mega_small_image" src="<?php echo e(asset('public/banner/business_news.png')); ?>" alt="Top Up" />
                                                                  <div class="text-centered" >
                                        ...
                                        <li aria-haspopup="true" id="company-nav" class="menu-dropdown mega-menu-dropdown <?php echo e((request()->segment(2) == 'view') ? 'active' : '' ||
                                        ...
                                        (request()->segment(2) == 'deactivatePage') ? 'active' : ''); ?>">
                                            ...
                                            <ul class="dropdown-menu pull-left">
                                                <li aria-haspopup="true" >
                                                    <a class="nav-link" href="<?php echo e(url('/profile/view')); ?>"> <i class="fa fa-video-camera" style="color: white"></i> View Company</a>
                                                </li>
                                                <li aria-haspopup="true" class="company-edit">
                                                        <a class="nav-link" href="<?php echo e(url('/profile/edit')); ?>"> <i class="fa fa-edit" style="color: white"></i> Edit Company</a>
                                                </li>
                                                <li aria-haspopup="true" class="company-contact">
                                                    <a href="<?php echo e(url('/profile/contacts')); ?>" class="nav-link "><i class="fa fa-phone-square" style="color: white"></i> Contacts </a>
                                                </li>
                                               <!-- <li aria-haspopup="true" class=" ">
                                                    <a href="<?php echo e(url('/profile/billing')); ?>" class="nav-link  "><i class="fa fa-money" style="color:white;"></i> Billing</a>
                                                </li> -->
                                                <li aria-haspopup="true" class="company-payment">
                                                    <a href="<?php echo e(url('/profile/paymentHistory')); ?>" class="nav-link"><i class="fa fa-cc-paypal" style="color: white"></i> Payments History</a>
                                                </li>
                                                <!--<li aria-haspopup="true" class=" ">
                                                    <a href="<?php echo e(url('/profile/socialAccounts')); ?>" class="nav-link"> <i class="fa fa-facebook-official" style="color: white"></i> Social Media Accounts</a>
                                                </li> -->
                                                <li aria-haspopup="true" class="company-deactivate">
                                                    <a href="<?php echo e(url('/profile/deactivatePage')); ?>" class="nav-link  "><i class="fa fa-warning" style="color: red;"></i> Deactivate Company</a>
                                                </li>
                                            </ul>
                                        ...
                                        <li aria-haspopup="true" id='nav-opportunities' class="menu-dropdown mega-menu-dropdown <?php echo e((request()->segment(1) == 'opportunity') ? 'active' : '' ||
                                            ...
                                            <ul class="dropdown-menu" style="max-width: 710px">
                                              <li>
                                                ...
                                                <li aria-haspopup="true" id="nav-my-opportunities">
                                                                        <a  href="<?php echo e(url('/opportunity')); ?>" class="nav-link  ">
                                                                          <i class="icon-bulb" style="color: white"></i> My Opportunities 
                                                                        </a>
                                                </li>

                                                <li aria-haspopup="true" id="nav-explore">
                                                                      <a href="<?php echo e(url('/opportunity/explore')); ?>" class="nav-link  ">
                                                          ...
                                                          <div class="col-md-9 div_right"  >
                                                            ...
                                                            <div class="mega-menu-submenu col-md-4 container_sm_img" 
                                                                        ...
                                                                        data-placement="left">
                                                              <a href="<?php echo e(route('opportunityExploreIndex')."?type=build&ids=".$item->id); ?>" >
                                                            ...
                                                            <div class="mega-menu-submenu col-md-4 container_sm_img" 
                                                                        ...
                                                                        data-content="<?=$item->business_goal?>"
                                                                        data-placement="left">
                                                              <a href="<?php echo e(route('opportunityExploreIndex')."?type=sell&ids=".$item->id); ?>" >
                                                                <img class="mega_small_image list-image" alt="profile image" 
                                                                  src="<?php echo e($avatarUrl); ?>">
                                                              </a>
                                                            </div>
                                                            ...
                                                            <div class="mega-menu-submenu col-md-4 container_sm_img" 
                                                                        ...
                                                                        data-content="<?=$item->business_goal?>"
                                                                        data-placement="left">
                                                              <a href="<?php echo e(route('opportunityExploreIndex')."?type=buy&ids=".$item->id); ?>" >
                                                                  <img class="mega_small_image list-image" alt="profile image" 
                                                                  src="<?php echo e($avatarUrl); ?>">
                                                              </a>
                                                            </div>
                                        ...
                                        <li aria-haspopup="true" id='nav-report' class="menu-dropdown mega-menu-dropdown <?php echo e((request()->segment(2) == 'status') ? 'active' : '' ||
                                        ...
                                        (request()->segment(2) == 'requesters') ? 'active' : ''); ?>">
                                            ...
                                            <ul class="dropdown-menu" style="min-width: 710px">
                                                ...
                                                <li aria-haspopup="true" id="nav-report-status">
                                                    <a href="<?php echo e(url('/reports/status')); ?>" class="nav-link  "><i class="icon-hourglass" style="color: white;"></i> Report Status </a>
                                                </li>
                                                <li aria-haspopup="true" id="nav-ongoing-monitoring">
                                                    <a href="<?php echo e(url('/monitoring/list')); ?>" class="nav-link  "><i class="icon-eye" style="color:white"></i> Ongoing Monitoring </a>
                                                </li>
<!--                                                 <li aria-haspopup="true" id="nav-buy-credit">
                                                    <a href="<?php echo e(url('/reports/buyCredits')); ?>" class="nav-link  "><i class="fa fa-dollar" style="color: white;"></i> Buy Credits</a>
                                                </li> -->

                                                <li aria-haspopup="true" id="nav-report-requester">
                                                    <a href="<?php echo e(url('/reports/requesters')); ?>" class="nav-link  "><i class="fa fa-user" style="color: white;"></i> Report Requesters </a>
                                                </li>
                                                                </ul>
                                                                <hr width="1" size="400">
                                                            </div>
                                                            ...
                                                            ?>
                                                              <div class="mega-menu-submenu col-md-3 container_sm_img" 
                                                                        ...
                                                                        data-placement="left">
                                                                <?php if( $build_list->where('view_type','2') OR $sell_list->where('view_type','2') OR $buy_list->where('view_type','2') ): ?>
                                                                  <?php if(App\SpentTokens::validateLeftBehindToken($company_id_result) != false && App\SpentTokens::validateLeftBehindToken($val->company_id) != false): ?>
                                                                      <a target="_blank" href="<?php echo e(url('/company/'.$viewer.'/'.$val->company_id.'/'.$val->id.'/'.$token)); ?>">
                                                                          <img class="mega_small_image list-image" src="<?php echo e(asset('public/banner/28_1583997690_smallPlant.jpeg')); ?>" alt="Top Up" />
                                                                      </a>
                                                                  <?php else: ?>
                                                                  ...
                                                                  <?php endif; ?>;
                                                                <?php else: ?>
                                                                  <?php if(App\SpentTokens::validateLeftBehindToken($val->company_id) == false 
                                        ...
                                        <?php } elseif($userType == 2) { ?>
                                            ...
                                            <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                                ...
                                                <a  href="<?php echo e(url('/homeSubConsul')); ?>" >
                                               ...
                                               <!-- <ul class="dropdown-menu pull-left">
                                                    <li aria-haspopup="true" class=" ">
                                                                <a href="<?php echo e(url('/businessnews')); ?>" class="nav-link  ">
                                            ...
                                            <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                                ...
                                                <a href="<?php echo e(url('/consultants/viewprofile')); ?>" >
                                                    <i class="icon-user"></i> Profile <span class="arrow"></span>
                                                </a>

                                                <ul class="dropdown-menu pull-left">
                                                    <li aria-haspopup="true" class=" ">
                                                        <a  href="<?php echo e(url('/consultants/viewprofile')); ?>" class="nav-link  "> <i class="icon-camcorder"></i> View Profile </a>
                                                    </li>
                                                    <li aria-haspopup="true" class=" ">
                                                        <a href="<?php echo e(url('/consultants/editprofile')); ?>" class="nav-link  "> <i class="icon-note"></i> Edit Profile </a>
                                                    </li>

                                                  <!--  <li aria-haspopup="true" class=" ">
                                                        <a href="<?php echo e(url('/consultants/billing')); ?>" class="nav-link  "> <i class="icon-map"></i> Billing </a>
                                                    </li> -->

                                                    <li aria-haspopup="true" class=" ">
                                                        <a href="<?php echo e(url('/consultants/commission')); ?>" class="nav-link  "> <i class=" icon-layers"></i> Commission History </a>
                                                    </li>
                                            ...
                                            <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                                ...
                                                <ul class="dropdown-menu pull-left">
                                                    <li aria-haspopup="true" class=" ">
                                                        <a  href="<?php echo e(url('/consultants/pending-projects')); ?>" class="nav-link  "> <i class="icon-pin"></i> Pending Projects </a>
                                                    </li>
                                                    <li aria-haspopup="true" class=" ">
                                                        <a href="<?php echo e(url('/consultants/ongoing-projects')); ?>" class="nav-link  ">  <i class="icon-target"></i> On-Going Projects</a>
                                                    </li>
                                                    <li aria-haspopup="true" class=" ">
                                                        <a href="<?php echo e(url('/consultants/archived-projects')); ?>" class="nav-link  "> <i class="icon-briefcase"></i> Archived Projects</a>
                                                    </li>
                                        ...
                                        <?php }elseif($userType == 3){ ?>
                                                ...
                                                <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                            <li aria-haspopup="true" class=" ">
                                                                    <a  href="<?php echo e(route('viewProfileMC')); ?>" class="nav-link  "> <i class="icon-camcorder"></i> View Profile </a>
                                                                </li>
                                                                <li aria-haspopup="true" class=" ">
                                                                    <a href="<?php echo e(route('editProfileMC')); ?>" class="nav-link  "> <i class="icon-note"></i> Edit Profile </a>
                                                                </li>
                                                    </ul>
                                                ...
                                                <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                                    ...
                                                    <ul class="dropdown-menu pull-left">
                                                            <li aria-haspopup="true" class=" ">
                                                                <a  href="<?php echo e(route('projectOverviewMC')); ?>" class="nav-link  "> <i class="icon-magnifier"></i> Overview Projects </a>
                                                            </li>
                                                            <li aria-haspopup="true" class=" ">
                                                                <a  href="<?php echo e(url('/mconsultants/projectPending')); ?>" class="nav-link  "> <i class="icon-pin"></i> Pending Projects </a>
                                                            </li>
                                                            <li aria-haspopup="true" class=" ">
                                                                <a href="<?php echo e(url('/mconsultants/projectOngoing')); ?>" class="nav-link  ">  <i class="icon-target"></i> On-Going Projects</a>
                                                            </li>
                                                            <li aria-haspopup="true" class=" ">
                                                                <a href="<?php echo e(url('/mconsultants/projectCompleted')); ?>" class="nav-link  "> <i class="icon-briefcase"></i> Completed Projects</a>
                                                            </li>
                                                    </ul>
                                       ...
                                       <?php } elseif($userType == 4){ ?>
                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                                ...
                                                <ul class="dropdown-menu pull-left">
                                                        ...
                                                        <li aria-haspopup="true" class=" ">
                                                                <a href="<?php echo e(url('/thomson')); ?>" class="nav-link  ">
                                                                <i class="icon-bulb" style="color: white"></i> Thomson Reuters </a>
                                                        </li>

                                                        <li aria-haspopup="true" class="">
                                                            <a href="<?php echo e(url('/opportunity/explore')); ?>">
						...
						<li aria-haspopup="true" class=" ">
                                                <a href="<?php echo e(url('/transferCompany')); ?>" class="nav-link  ">
                                                    Company Transfer and Token</a>
                                               </li>
                                                <li aria-haspopup="true" class=" ">
                                                    <a href="<?php echo e(url('/sysconfig')); ?>" class="nav-link  ">
                                                        Configure Variables</a>
                                                </li>
                                                <li aria-haspopup="true" class=" ">
                                                    <a href="<?php echo e(url('/sysconfig/assignConsultants')); ?>" class="nav-link  ">
                                                        Consultant Mapping</a>
                                                </li>
                                                <li aria-haspopup="true" class=" ">
                                                    <a href="<?php echo e(url('/sysconfig/reportTemplate')); ?>" class="nav-link  ">
                                                        Configure Report Templates</a>
                                                </li>
						
 						<li aria-haspopup="true" class=" ">
                                                  <a href="<?php echo e(url('/req-list')); ?>" class="nav-link  ">
                                                      Company Request Ownership and Removal</a>
                                              </li>

                                              <li aria-haspopup="true" class=" ">
                                                  <a href="<?php echo e(url('/auditTrailLog/view')); ?>" class="nav-link  ">
                                                      View Audit Trail</a>
                                              </li>
                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown">
                                            <a href="<?php echo e(route('approvalPageAdmin')); ?>">
                                        ...
                                        <li aria-haspopup="true" class="">
                                            <a href="<?php echo e(url('/accountsCompanies')); ?>">
                                                <i class="icon-bar-chart" style="color:white;"></i> <span class="font-white">Companies</span>
                                            </a>
                                        </li>

                                        <li aria-haspopup="true" class="">
                                                <a href="<?php echo e(url('/manage-registration-links')); ?>">
                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-left">
                                              <li aria-haspopup="true" class=" ">
                                                <a href="<?php echo e(url('/opportunity/details')); ?>" class="nav-link  ">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <!-- <?php if(auth()->guard()->guest()): ?>
                        ...
                        <?php else: ?>
                            <li class="nav-item"> -->
                            <!-- <a href="#">
                                    <?php echo e(Auth::user()->firtsname); ?> <span class="caret"></span>
                                </a> -->
    ...
    <div class="popup" data-popup="popup-company">
        <div class="popup-inner">
            ...
            <div id="add_company_profile">
                <form action="<?php echo e(route('homeAddCompany')); ?>" method="POST">
                        <?php echo e(csrf_field()); ?>
            ...
            <table class="table table-bordered table-striped table-condensed flip-content" style="width: 100%; padding-top: 5px;">
                    ...
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?></td>
                        <td>
                                <form action="<?php echo e(route('homeSelectCompany')); ?>" method="POST">
                                        <?php echo e(csrf_field()); ?>
...
function updateTour(is_end = 'none'){
  ...
  formData.append("auth_id", <?php echo e(Auth::id()); ?> );
  formData.append("scope", '<?=  $scope ?>');
  formData.append("is_end", is_end);

  $.ajax({
      url: "<?php echo e(route('updateTour')); ?>",
      type: "POST",
      data: formData,
