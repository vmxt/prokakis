...
<script src="<?php echo e(asset('public/jq-autocomplete/jquery-1.11.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/jq-autocomplete/jquery.easy-autocomplete.min.js')); ?>"></script>
<link href="<?php echo e(asset('public/jq-autocomplete/easy-autocomplete.min.css')); ?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo e(asset('public/jq-autocomplete/easy-autocomplete.themes.min.css')); ?>" rel="stylesheet"
      type="text/css"/>
...
<style>
    #chat-wrap {
      background-image: url("<?php echo e(asset('public/img-resources/chat-backdrop.png')); ?>");
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/explore.css')); ?>">
...
?>
        ...
        <?php if($i <= 2): ?>
              <div class='post build-list'>
                ...
                ?>
                    <div class='follow-cont' dataVal="<?php echo e($company->id); ?>">
                        <i class="fas <?php echo e($iconName); ?> fa-1x follow-icon followicon_<?php echo e($company->id); ?>" title="<?php echo e($iconTitle); ?>"  ></i>
                    </div>

                <a href='#'>
                    <div class='image' style='background-image: url( <?php echo e($avatarUrl); ?> )'>

                <?php if($accStatus == 'premium'): ?>
                    <img class="premium_banner" alt="Premium Banner" src="<?php echo e(asset('public/banner/premium_banner.png')); ?>">
                <?php endif; ?>
                    </div>
                  <div class='content'>
                    <h1 class='upperText' title="<?php echo e($item->opp_title); ?>"> <?= $item->opp_title != "" ? $item->opp_title : 'Providing Business Valuation' ?></h1>
                     <div class="hr-sect"><strong class="hr_title">This company is seeking</strong></div>
                        <ul class="info_list">
                            <?php if($item->business_goal): ?>
                            <li> <?php echo e($item->business_goal); ?></li>
                            <?php endif; ?>
                            <?php if($item->audience_target): ?>
                            <li> <?php echo e($item->audience_target); ?></li>
                            <?php endif; ?>
                            <?php if($item->ideal_partner_base): ?>
                            <li>
                            <?php 
                    ...
                    <div class="hr-sect"><strong class="hr_title">Expectation</strong></div>
                        <p class='meta'> <?php echo e($item->timeframe_goal); ?>

                        <?php echo e($item->approx_large); ?> opportunity. </p>
                    <div style="display: flex;">
                        <div>
                            <?php if($ratingScore < 25): ?>
                                <img width="30" height="32"
                                     src="<?php echo e(asset('public/stars/p1.png')); ?>">
                                <img width="30" height="32"
                                     src="<?php echo e(asset('public/stars/p1.png')); ?>">
                                <img width="30" height="32"
                                     src="<?php echo e(asset('public/stars/p1.png')); ?>">
                            <?php elseif($ratingScore >= 26 && $ratingScore <= 50): ?>
                                <img width="30" height="32"
                                     src="<?php echo e(asset('public/stars/p2.png')); ?>">
                                <img width="30" height="32"
                                     src="<?php echo e(asset('public/stars/p1.png')); ?>">
                                <img width="30" height="32"
                                     src="<?php echo e(asset('public/stars/p1.png')); ?>">
                        ...
                        <div class="rating_score">
                            <h3> <?php echo e($ratingScore); ?>% </h3>
                        </div>
                    </div>
                    <div class="learn_more" style="float: right" >
                           <button onclick="showModalContent('build','<?php echo e($item->id); ?>')" class="btn btn-primary "> Learn More</button>
                    </div>
...
<?php      
    ...
    <div 
        class="modal fade modal_oppoBox build_modal_<?php echo e($buildCount); ?>" 
        id="opporBuildModal_<?php echo e($item->id); ?>" 
        ...
        <div class="modal-body">
            ...
            <div id='rating_section_<?php echo e($buildCount); ?>'>
                ...
                <?php
                    ...
                    <h2 class="rating_score"  > <?php echo e($ratingScore); ?> % </h2>
                </div>
                <hr>
            </div>

            <div id='seeking_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
            ...
            <div id='expectation_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
                    <h4><strong> Expectation </strong></h4>
                </span>
                <span class="content-text">
                    <h4> 
                        <?php echo e($item->timeframe_goal); ?>

                        <?php echo e($item->approx_large); ?> opportunity.
            ...
            <div id='revenue_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
                    <h4><strong> Estimated Revenue Per Year </strong></h4>
                </span>
                <span class="content-text">
                    <h4> 
                        <?php echo e($item->est_revenue); ?>.
                    </h4>
                </span>
                <hr>
            </div>

            <div id='profit_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
                    <h4><strong> Estimated Profit Per Year </strong></h4>
                </span>
                <span class="content-text">
                    <h4> 
                        <?php echo e($item->est_profit); ?>.
                    </h4>
                </span>
                <hr>
            </div>

            <div id='keyword_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
            ...
            <div id='oppo_desciption_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
                    <h4><strong> Description about this opporunity?  </strong></h4>
                </span>
                <span class="content-text">
                    <h4> <?php echo e($item->oppo_description); ?> </h4>
                </span>
                <hr>
            </div>

            <div id='whypartner_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
                    <h4><strong> Why partner with this company?  </strong></h4>
                </span>
                <span class="content-text">
                    <h4> <?php echo e($item->why_partner_goal); ?> </h4>
                </span>
                <hr>
            </div>

            <div id='relevant_section_<?php echo e($buildCount); ?>'>
                <span class="title-text">
            ...
            <div>
              <?php if($tokenStock >= 12): ?>
                <a id='dilligence_btn_<?php echo e($buildCount); ?>' onclick="processReq('build', '<?php echo e($item->id); ?>');" class="btn blue btn_options"><span class="fa fa-check"></span> Due Diligence Report</a>
              <?php else: ?>
                <a id='dilligence_btn_<?php echo e($buildCount); ?>' onclick="stockTokenInfo('<?php echo e($tokenStock); ?>');" class="btn blue btn_options"><span class="fa fa-check"></span> Due Diligence Report</a>
              <?php endif; ?>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) == false && App\SpentTokens::validateAccountActivation($provider_id) != false): ?>
                    <a id='viewprofile_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="nonPremiumToPremium('<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>','1');" class="btn default btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>

                    <?php if($tokenStock >= 3): ?>
                        <?php if(App\ChatHistory::getChatPayStatus($item->id, 'build', $requestor_id, $provider_id) == false): ?>
                        <a id='connectme_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="DeductThreeInboxMe('<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($item->id); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>' , 'build');" class="btn default btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
                        <?php else: ?>
                        <a id='connectme_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppInboxMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','build');" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>

                        <?php if(App\VideoChat::getVcURL($item->id, 'build', $requestor_id) == null){ ?>
                        <a id='videochat_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppVcMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','build');" class="btn blue btn_options"> <span class="fa fa-video-camera"></span> &nbsp; Video Chat Me</a>
                        <?php } else { ?>
                        <a id='videochat_btn_<?php echo e($buildCount); ?>' href="<?php echo App\VideoChat::getVcURL($item->id, 'build', $requestor_id); ?>" target="_blank" Opptype="<?php echo e($opportunity_type); ?>" class="btn blue btn_options"> <span class="fa fa-video-camera"></span> &nbsp; Video Chat Me</a>
                        <?php } ?>    

                        <?php endif; ?>
                    <?php else: ?>
                    <a id='connectme_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="BlockInboxMe();" class="btn default btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
                    <?php endif; ?>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) != false && App\SpentTokens::validateAccountActivation($provider_id) != false): ?>
                    <a id='viewprofile_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="PremiumToPremium(<?php echo e($company->id); ?>, <?php echo e($requestor_id); ?>,'<?php echo e(url('/company/'.$viewer.'/'.$company->id)); ?>', '2');" class="btn blue btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) == false && App\SpentTokens::validateAccountActivation($provider_id) == false): ?>
                    <a id='viewprofile_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="nonPremiumToNonPremium('<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>','1');" class="btn default btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) != false && App\SpentTokens::validateAccountActivation($provider_id) == false): ?>
                    <a id='viewprofile_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="premiumToNonPremium('<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>','1');" class="btn default btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>
                    <a id='connectme_btn_<?php echo e($buildCount); ?>' href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppInboxMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','build');" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
                ...
                <?php if(App\User::getEBossStaffTrue(Auth::id()) == true): ?>
                  <a href="<?php echo e(url('/opportunity/deleteBuild/'.$item->id)); ?>"
              ...
              <div class='post sell-list'>
                ...
                <?php endif; ?>
                  ...
                  <div class='content'>
                    ...
                    <div class="learn_more" style="float: right" >
                           <button onclick="showModalContent('sell','<?php echo e($item->id); ?>')" class="btn btn-primary "> Learn More</button>
                    </div>
                    <div class="bottom-space" >
                        &nbsp;
                    </div>
...
<?php      
    ...
    <div 
        ...
        id="opporSellModal_<?php echo e($item->id); ?>" 
        tabindex="-1" role="dialog" 
        aria-labelledby="opporDetailsContentModalLabel" 
        aria-hidden="true">
        <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div>
              <?php if(  $tokenStock >= 12): ?>
                <a onclick="processReq('sell', '<?php echo e($item->id); ?>');" class="btn blue btn_options"><span class="fa fa-check"></span> Due Diligence Report</a>
              <?php else: ?>
                <a onclick="stockTokenInfo('<?php echo e($tokenStock); ?>');" class="btn blue btn_options"><span class="fa fa-check"></span> Due Diligence Report</a>
              <?php endif; ?>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) == false && App\SpentTokens::validateAccountActivation($provider_id) != false): ?>
                    <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="nonPremiumToPremium('<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>','1');" class="btn default btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>

                    <?php if($tokenStock >= 3): ?>

                        <?php if(App\ChatHistory::getChatPayStatus($item->id, 'sell', $requestor_id, $provider_id) == false): ?>
                            <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="DeductThreeInboxMe('<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($item->id); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>' , 'sell');" class="btn default btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
                        <?php else: ?>
                            <a href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppInboxMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','sell');" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>

                            <?php if(App\VideoChat::getVcURL($item->id, 'sell', $requestor_id) == null){ ?>
                            <a href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppVcMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','sell');" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Video Chat Me</a>
                            <?php } else { ?>
                            <a href="<?php echo App\VideoChat::getVcURL($item->id, 'sell', $requestor_id); ?>" target="_blank" Opptype="<?php echo e($opportunity_type); ?>" class="btn blue btn_options"> <span class="fa fa-video-camera"></span> &nbsp; Video Chat Me</a>
                            <?php } ?>    
                            
                        <?php endif; ?>

                    <?php else: ?>
                    <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="BlockInboxMe();" class="btn default btn_options"> <span class="fa fa-comment"></span> &nbsp; Video Chat Me</a>
                    <?php endif; ?>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) != false && App\SpentTokens::validateAccountActivation($provider_id) != false): ?>
                    <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="PremiumToPremium(<?php echo e($company->id); ?>, <?php echo e($requestor_id); ?>,'<?php echo e(url('/company/'.$viewer.'/'.$company->id)); ?>', '2');" class="btn blue btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) == false && App\SpentTokens::validateAccountActivation($provider_id) == false): ?>
                    <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="nonPremiumToNonPremium('<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>','1');" class="btn default btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>
                    ...
                    <?php else: ?>
                    <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="BlockInboxMe();" class="btn default btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
                    <?php endif; ?>
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) != false && App\SpentTokens::validateAccountActivation($provider_id) == false): ?>
                    <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="premiumToNonPremium('<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>','1');" class="btn default btn_options"> <span class="fa fa-credit-card"></span> View Profile</a>

                    <a href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppInboxMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','build');" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
              ...
              <div class='post buy-list'>
                ...
                <?php endif; ?>
                  ...
                  <div class='content'>
                    ...
                    <div class="learn_more" style="float: right" >
                           <button onclick="showModalContent('buy','<?php echo e($item->id); ?>')" class="btn btn-primary "> Learn More</button>
                    </div>
                    <div class="bottom-space" >
                        &nbsp;
                    </div>
...
<?php      
    ...
    <div 
        class="modal fade modal_oppoBox" 
        id="opporBuyModal_<?php echo e($item->id); ?>" 
        tabindex="-1" role="dialog" 
        aria-labelledby="opporDetailsContentModalLabel" 
        aria-hidden="true">
        <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div>
              <?php if(  $tokenStock >= 12): ?>
                <a onclick="processReq('buy', '<?php echo e($item->id); ?>');" class="btn blue btn_options"><span class="fa fa-check"></span> Due Diligence Report</a>
              <?php else: ?>
                <a onclick="stockTokenInfo('<?php echo e($tokenStock); ?>');" class="btn blue btn_options"><span class="fa fa-check"></span> Due Diligence Report</a>
              <?php endif; ?>
                <?php 
                ...
                <?php if(App\SpentTokens::validateAccountActivation($requestor_id) == false && App\SpentTokens::validateAccountActivation($provider_id) != false): ?>
                    ...
                    <?php if($tokenStock >= 3): ?>
                        ...
                        <?php if(App\ChatHistory::getChatPayStatus($item->id, 'buy', $requestor_id, $provider_id) == false): ?>
                            <a href="#" Opptype="<?php echo e($opportunity_type); ?>" onclick="DeductThreeInboxMe('<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($item->id); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>' , 'buy');" class="btn default btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
                        <?php else: ?>
                            <a href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppInboxMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','buy');" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Connect Me</a>
                            
                            <?php if(App\VideoChat::getVcURL($item->id, 'buy', $requestor_id) == null){ ?>
                            <a href="#" Opptype="<?php echo e($opportunity_type); ?>"  onclick="OppVcMe( '<?php echo e($avatarUrl); ?>','<?php echo e($item->opp_title); ?>', '<?php echo e($company->id); ?>', '<?php echo e($requestor_id); ?>', '<?php echo e($item->id); ?>','buy');" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Video Chat Me</a>
                            <?php } else { ?>
                            <a href="<?php echo App\VideoChat::getVcURL($item->id, 'buy', $requestor_id); ?>" target="_blank"  Opptype="<?php echo e($opportunity_type); ?>" class="btn blue btn_options"> <span class="fa fa-comment"></span> &nbsp; Video Chat Me</a>
                            <?php } ?>     
 ...
 <?php
        ...
        if ($ratingScore < 25) {
            ?>
                                        ...
                                        <?php }?>
                                        <br/>
                <h4 class="rating_score"> <?php echo e($ratingScore); ?> % </h4>
            </span>
            <hr>
        </div>
        <div>
            ...
            <span class="content-text">
                <h4>
                    <ul>
                        <?php if($opp_type == 'build'): ?>
                        <li><?php echo e($result_filter->business_goal); ?></li>
                        <?php else: ?>
                        <li><?php echo e($result_filter->what_sell_offer); ?></li>
                        <?php endif; ?>
                        <li><?php echo e($result_filter->audience_target); ?></li>
                        <li>
            <?php 
        ...
        <div>
            ...
            <span class="content-text">
                <h4> 
                    <?php echo e($result_filter->timeframe_goal); ?>

                    <?php echo e($result_filter->approx_large); ?> opportunity.
...
?>
        ...
        <div>
            ...
            <span class="content-text">
                <h4> <?php echo e($result_filter->why_partner_goal); ?> </h4>
            </span>
            <hr>
        </div>
 ...
 <div class='intro-tour-overlay'></div>
    ...
    <script>
        ...
        function showModalContent(type, id){
            ...
            $.ajax({
                url: "<?php echo e(route('saveAuditTrailLog')); ?>",
                type: "POST",
                data: formData,
        ...
        $(document).ready(function () {
            ...
            $(".follow-cont").click(function (e) {
                    ...
                    var comp_id = $(this).attr('dataVal');
                      ...
                      $.ajax({
                          url: "<?php echo e(route('updateFollowCompany')); ?>",
                          type: "POST",
                          async: true,
                          data: formData,
                          headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
        ...
        var options = {
            url: "<?php echo e(url('public/json/keywords.json')); ?>",
            getValue: "keyword",
            list: {
                match: {
                    enabled: true
        ...
        var optionsCountry = {
            url: "<?php echo e(route('getCountryList')); ?>",
            getValue: "country",
            list: {
                match: {
                    enabled: true
        ...
        function stockTokenInfo(stockToken){
          ...
          swal({
              ...
              icon:  'warning'
                ...
                window.location.href = "<?php echo e(route('reportsBuyTokens')); ?>";
            });
        }
                ...
                if (isConfirm) {
                  swal({
                    ...
                    formData.append("oppId", oppId);
                        ...
                        $.ajax({
                            url: "<?php echo e(route('PremiumPurchase')); ?>",
                            type: "POST",
                            data: formData,
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            processData: false,
                            ...
                            success: function (data) {
                                ...
                                document.location = '<?php echo e(url("opportunity/explore")); ?>';
            ...
            $('.modal_oppoBox').modal('hide');
              swal({
                  ...
                  if (isConfirm) {
                      ...
                      $.ajax({
                          url: "<?php echo e(route('emailNotification')); ?>",
                          type: "POST",
                          async: true,
                          data: formData,
                          headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                          ...
                          success: function (data) {
                              swal({
                                ...
                                icon:  'success'
                                     ...
                                     //document.location = '<?php echo e(url("reports/buyTokens")); ?>';
                                  document.location = '<?php echo e(url("/home")); ?>';
        ...
        function DeductThreeInboxMe(avatarUrl, oppTitle, oppId, companyOpp, companyViewer, oppType)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('getChatCredit')); ?>",
                        type: "POST",
                        async: true,
                        data: formData,
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                ...
                if (isConfirm) {
                  swal({
                    ...
                    formData.append("companyViewer", companyViewer);
                        ...
                        $.ajax({
                            url: "<?php echo e(route('AlertFreeAccount')); ?>",
                            type: "POST",
                            data: formData,
                            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            processData: false,
...
function getStateOfChat(){
  ...
  if(!instanse){
     instanse = true;
      ...
      $.ajax({
          url: "<?php echo e(route('chatProcess')); ?>",
          type: "POST",
          data: formData,
          headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
          processData: false,
