    ...
    <script>
        $(document).ready(function () {
            ...
            $("#building").click(function () {
                $(location).attr("href", "<?php echo e(route('opportunityNewBuild')); ?>");
            });

            $("#selling").click(function () {
                $(location).attr("href", "<?php echo e(route('opportunitySellOffer')); ?>");
            });

            $("#buying").click(function () {
                $(location).attr("href", "<?php echo e(route('opportunityBuy')); ?>");
            });
