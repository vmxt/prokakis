    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12" style="min-height:800px">
                ...
                <form id="opportunity_build_form" method="POST" action="<?php echo e(route('opportunityStoreSellOffer')); ?>">
                            ...
                            <div class="portlet light" id="sect_value_opportunity">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="approx_large"><b>What is the estimated revenue per year? </b> </label>
                            ...
                            <div class="portlet light" id="sect_value_opportunity">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="approx_large"><b>What is the estimated profit per year? </b> </label>
